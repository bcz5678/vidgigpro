...
Generated from the 'canary' branch to include sequelize support. Checkout `canary` then doing a `npm link`. Yoeman will use your local version now.

Modified from the original output to resolve issues with building and Heroku deployment.
...
If you're using PostgreSql you will need to add a database to your app:
